  ...
  return (
    <div className="h-full text-center flex flex-col justify-center items-center">
      ...
      <div className="w-full flex flex-col justify-center items-center">
        <div className="w-full flex my-8 py-3 px-4 rounded-full items-center justify-center border max-w-[90%] hover:shadow-md focus-within:shadow-md sm:max-w-xl lg:max-w-2xl">
